...
export const Content = ({ BlockPicture1, BlockPicture2, BlockPicture3, BLockText1, BLockText2, BLockText3, BLockTitle1, BLockTitle2, BLockTitle3, catalog_Name, address, blockImg1, blockImg2, blockImg3, blockImg4 }) => {
  const map1 = [
    { id: 1, img: BlockPicture1, text: BLockText1, title: BLockTitle1 },
    { id: 2, img: BlockPicture2, text: BLockText2, title: BLockTitle2 },
    { id: 3, img: BlockPicture3, text: BLockText3, title: BLockTitle3 }
  ]
  const map2 = map1.map(a => <div key={a.id} className={style.Wedding_Hall_Cost}>
    <img src={a.img} alt="" />
